;;; private/xfu/local/company-quickhelp-childframe.el -*- lexical-binding: t; -*-
...
(defun company-quickhelp--hide ()
  ...
  (when (frame-live-p company-quickhelp-childframe-child-frame)
    (set-frame-parameter company-quickhelp-childframe-child-frame 'alpha 0)
    (make-frame-invisible company-quickhelp-childframe-child-frame)))
