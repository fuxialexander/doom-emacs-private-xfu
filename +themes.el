...
;; ** dired
                ...
                (diredfl-dir-name               :foreground blue :inherit 'diredfl-file-name)
                (diredfl-autofile-name          :foreground base4 :inherit 'diredfl-file-name)
                (diredfl-compressed-file-name   :foreground yellow :inherit 'diredfl-file-name)
                (diredfl-compressed-file-suffix :foreground (doom-blend orange bg-alt 0.6) :inherit 'diredfl-file-name)
                (diredfl-date-time              :foreground cyan :weight 'light :inherit 'diredfl-file-name)
                ...
                (diredfl-dir-heading            :foreground blue :weight 'bold :inherit 'diredfl-file-name)
                (diredfl-dir-priv               :foreground blue :inherit 'diredfl-file-name)
                (diredfl-exec-priv              :foreground green :inherit 'diredfl-file-name)
                (diredfl-executable-tag         :foreground green :inherit 'diredfl-file-name)
                (diredfl-file-suffix            :foreground (doom-blend fg bg-alt 0.6) :inherit 'diredfl-file-name)
                ...
                (diredfl-ignored-file-name      :foreground comments :inherit 'diredfl-file-name)
                (diredfl-link-priv              :foreground violet :inherit 'diredfl-file-name)
                (diredfl-no-priv                :foreground fg :inherit 'diredfl-file-name)
                (diredfl-number                 :foreground orange :inherit 'diredfl-file-name)
                (diredfl-other-priv             :foreground magenta :inherit 'diredfl-file-name)
                (diredfl-rare-priv              :foreground fg :inherit 'diredfl-file-name)
                (diredfl-read-priv              :foreground yellow :inherit 'diredfl-file-name)
                (diredfl-symlink                :foreground violet :inherit 'diredfl-file-name)
                (diredfl-tagged-autofile-name   :foreground base5 :inherit 'diredfl-file-name)
                (diredfl-write-priv             :foreground red :inherit 'diredfl-file-name)
;; ** flycheck
...
(byte-recompile-directory
 (car (file-expand-wildcards "~/.emacs.d/.local/packages/elpa/doom-themes-*")) nil t)
;; (doom/reload-theme)
