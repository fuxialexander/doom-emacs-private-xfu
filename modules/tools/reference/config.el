...
(def-package! org-ref-ivy :load-path "/Users/xfu/.doom.d/modules/tools/reference/local/org-ref-ivy"
...
(def-package! org-ref-doi-utils :load-path "modules/tools/reference/local/org-ref-ivy"
  :after org-ref-ivy)
(def-package! org-ref-url-utils :load-path "modules/tools/reference/local/org-ref-ivy"
  :after org-ref-ivy)
(def-package! org-ref-arxiv :load-path "modules/tools/reference/local/org-ref-ivy"
  :after org-ref-ivy)
(def-package! org-ref-wos :load-path "modules/tools/reference/local/org-ref-ivy"
  :after org-ref-ivy)
(def-package! org-ref-scopus :load-path "modules/tools/reference/local/org-ref-ivy"
  :after org-ref-ivy)
