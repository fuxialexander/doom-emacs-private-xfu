...
(def-package! sx
  ...
  (set-evil-initial-state! 'sx-question-mode 'insert)
  (set-evil-initial-state! 'sx-question-list-mode 'insert)
  (map!
   ...
   (:after sx-question-mode
     ...
     :ni "q" #'quit-window))
  (set-popup-rule! "\\*sx-search-result\\*" :slot -1 :side 'right :size 100 :select t :quit nil :transient t)
  (set-popup-rule! "\\*sx-question\\*" :slot 0 :side 'right :height 0.6 :select t :quit nil :transient t)
